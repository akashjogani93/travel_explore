...
<div class="page-content container-fluid">
    <div class="footer">
        <div class="d-flex justify-content-between">
            <h2 class="text-center" style="font-weight: 600">Places ADD AND VIEW</h2>
        </div>
    </div>
</div>
...
<main class="page-content">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="box">
          <h4>Add Places Details</h4><hr />
          <!-- <form> -->
            <div class="form-group">
              <label for="title">Select Package:</label>
  ...
  <script>
    $(document).ready(function() 
    {
      ...
      $('#places').click(function()
      {
        ...
        var inputIds = ['#pkg, #title','#location', '#des','#path'];
